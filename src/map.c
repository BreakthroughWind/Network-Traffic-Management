...
void ds_hashmap_free(struct DSHashMap *hash, bool free_data, bool free_string_keys)
{
...
void ds_puts(struct DSHashMap *hash, char *key, void *data)
{
  ds_hashmap_put_str(hash, key, data);
}

void ds_hashmap_put_str(struct DSHashMap *hash, char *key, void *data)
{
  ds_hashmap_put(hash, data, key, 0, DS_HASHMAP_KEY_STRING);
}

void ds_puti(struct DSHashMap *hash, int32_t key, void *data)
{
  ds_hashmap_put_int(hash, key, data);
}

void ds_hashmap_put_int(struct DSHashMap *hash, int32_t key, void *data)
{
...
void ds_hashmap_remove_str(struct DSHashMap *hash, char *key, bool free_data,
...
void ds_hashmap_remove_int(struct DSHashMap *hash, int32_t key, bool free_data)
{
...
void ds_hashmap_print_keys(struct DSHashMap *hash)
{
  int32_t i;
...
void ds_hashmap_print_keyvals(struct DSHashMap *hash, char *(tostring)(void *))
{
  int32_t i;
...
void ds_hashmap_sort_keys(struct DSHashMap *hash)
{
  ds_hashmap_sort_by(hash, ds_hashmap_compare_keys);
}

void ds_hashmap_sort_by(struct DSHashMap *hash, int32_t(compare)(void *, void *))
{
